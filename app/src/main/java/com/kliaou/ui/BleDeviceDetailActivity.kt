...
class BleDeviceDetailActivity : AppCompatActivity() {
    ...
    private var mChatCaller: Int = ChatCaller.Server//default caller
...
//        mRemoteGenderView!!.setText(R.string.no_data)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mChatCaller = intent.getIntExtra(BleChatActivity.EXTRAS_CHAT_CALLER, mChatCaller)
        ...
        findViewById<View>(R.id.btn_greeting)!!.setOnClickListener {
            ...
            showChatActivity.putExtra(BleChatActivity.EXTRAS_CHAT_CALLER, mChatCaller)
...
//        if(remoteInfoRefreshHandler != null) remoteInfoRefreshHandler.removeCallbacks(remoteInfoRefreshTask)
   ...
   */
    ...
    companion object {
        private val TAG = BleDeviceDetailActivity::class.java.simpleName
